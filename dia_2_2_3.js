/*
    Crie uma função que gera um numero aleatorio entre 1 e 1000.

    Crie outra função que tem que chutar valores até acertar qual valor foi informado na função acima.
